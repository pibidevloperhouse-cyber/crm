    ...
    <>
              ...
              <Dialog open={editOpen} onOpenChange={setEditOpen}>
                ...
                <DialogContent className="max-w-[80vw] w-[80vw] h-[85vh] overflow-hidden flex flex-col p-0">
                  ...
                  <div className="flex-1 overflow-y-auto p-6">
                    <Updateleads lead_id={lead.id} onChange={onChange} fetchLeads={fetchLeads} fetchDeals={fetchDeals} />
                  </div>
                </DialogContent>
              </Dialog>
              <Button
      ...
      <Dialog open={emailOpen} onOpenChange={setEmailOpen}>
        <DialogContent className="w-[95vw] sm:max-w-4xl h-[90vh] sm:h-[85vh] p-0 overflow-hidden border-0 shadow-2xl mx-auto">
          <EmailTemplate type="Leads" id={lead.id} email={lead.email} onOpenChange={setEmailOpen} />
        </DialogContent>
      </Dialog>
      ...
      >
        <DialogContent className="max-w-lg">
          ...
          <div className="space-y-3">
              ...
              <>
                <div className="space-y-1.5">
                  <label className="text-xs font-medium text-slate-500 dark:text-slate-400 flex items-center gap-1.5">
                    <Package className="w-3.5 h-3.5 text-teal-500" /> Product Name
                  </label>
                  {loadingProducts ? (
                ...
                <div className="space-y-1.5">
                  <label className="text-xs font-medium text-slate-500 dark:text-slate-400 flex items-center gap-1.5">
                    <Building2 className="w-3.5 h-3.5 text-teal-500" /> Company Name
                  </label>
                  <Input
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-medium text-slate-500 dark:text-slate-400 flex items-center gap-1.5">
                <Tag className="w-3.5 h-3.5 text-teal-500" /> Stage Note
              </label>
              <Textarea
          ...
          <DialogFooter>
            ...
            <Button className="bg-gradient-to-r from-sky-700 to-teal-500 text-white" onClick={handleStatusUpdate}>
              Save Progress
            </Button>
          </DialogFooter>
        </DialogContent>
