            ...
            <div className="flex flex-col gap-4 py-4">
              ...
              <div className="flex flex-col gap-3">
                ...
                <BillingCycleSelect
                  ...
                  onValueChange={(value) => setNewProduct((prev) => ({ ...prev, billingCycle: value }))}
                />
              </div>
              <div className="flex items-center gap-3">
                <Switch
                  ...
                  onCheckedChange={(value) => setNewProduct({ ...newProduct, isConfigurable: value })}
                />
                ...
                <div className="p-5">
                  ...
                  <div className={`flex justify-end ${product.isActive === false ? "flex" : "hidden"}`}>
                    <Button
                      ...
                      onClick={() => {
                        setReinstate(true);
                        setNewProduct({ ...product, isActive: true, name: product.name + "-" + today.getFullYear() });
                        addProduct();
                        handleUpdate();
                        setReinstate(false);
                      }}
