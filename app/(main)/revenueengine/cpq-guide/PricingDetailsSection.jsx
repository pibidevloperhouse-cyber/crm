                            ...
                            <Tooltip>
                              <TooltipTrigger asChild>
                                <div className={`relative flex items-center h-8 rounded-lg outline outline-1 outline-offset-[-1px] transition-all duration-300 w-[120px] mx-auto ${
                                  isAutoApplied ? "bg-amber-50/50 dark:bg-amber-500/[0.03] outline-amber-400/40 dark:outline-amber-500/40 shadow-[0_0_15px_-3px_rgba(251,191,36,0.15)]" : "bg-slate-50 dark:bg-slate-900/40 outline-slate-200 dark:outline-slate-800"
                                }`}>
                                  <div className="flex-1 flex items-center border-r border-slate-200/60 dark:border-slate-800 h-full">
                                    <Input
                                      className={`w-full h-full p-0 bg-transparent border-none shadow-none focus-visible:ring-0 text-right font-mono text-[13px] font-black tracking-tight ${
                                        isAutoApplied ? "text-amber-700 dark:text-amber-400" : "text-slate-800 dark:text-white"
                                      }`}
                                  ...
                                  <div className="flex px-1 gap-0.5 shrink-0 items-center h-full">
                                    <button onClick={() => {
                                      ...
                                      status === "accepted" ? "bg-emerald-500/10 text-emerald-600 ring-1 ring-emerald-500/30" : "text-slate-400 hover:text-emerald-500 hover:bg-emerald-500/10"
                                    }`}>✓</button>
                                    <button onClick={() => {
                                      handleChange("user_discount", index, 0);
                                      handleChange("auto_discount_status", index, "rejected");
                                    }} className={`w-6 h-6 flex items-center justify-center rounded-md transition-colors ${
                                      status === "rejected" ? "bg-red-500/10 text-red-600 ring-1 ring-red-500/30" : "text-slate-400 hover:text-red-500 hover:bg-red-500/10"
                                    }`}>✕</button>
                                  </div>
                                </div>
                              </TooltipTrigger>
