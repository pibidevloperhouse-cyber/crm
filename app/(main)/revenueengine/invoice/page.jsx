      ...
      <div className="w-full mb-6 relative z-[50] rounded-2xl p-1.5 flex flex-col md:flex-row gap-3 items-center justify-between bg-white/40 dark:bg-slate-900/40 backdrop-blur-md border border-[#25C2A0]/20 dark:border-slate-800/60 shadow-lg dark:shadow-none">
                  ...
                  searchSuggestions.map((deal) => (
                    ...
                    >
                      <div className="flex flex-col">
                        <span className="font-semibold text-teal-900 dark:text-slate-200">
                          {deal.name}
                        </span>
                        <span className="text-xs text-teal-600/60 dark:text-slate-400">
        ...
        <div className="flex gap-3 w-full md:w-auto p-2">
          <div className="relative flex items-center w-full md:w-auto">
            ...
            >
              ...
              <SelectContent className="rounded-xl border-slate-200 dark:border-slate-800">
                <SelectGroup>
                  <SelectLabel className="text-xs uppercase text-slate-400 font-bold p-3">
                    Available Products
                  </SelectLabel>
                  <SelectItem value="all" className="rounded-lg m-1">
                    All Portfolio
                  </SelectItem>
          ...
          <Button
            ...
            variant="ghost"
            size="icon"
            className={`h-11 w-11 rounded-xl bg-white/60 dark:bg-slate-950 text-slate-400 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 transition-all ${
              searchTerm !== "" ||
            ...
            dealsToShow.map((deal, index) => {
              ...
              return (
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <Card className="overflow-hidden border border-[#25C2A0]/10 shadow-lg dark:shadow-none bg-white/40 dark:bg-slate-900/50 backdrop-blur-md rounded-3xl group hover:shadow-[#25C2A0]/5 transition-all duration-300">
                      ...
                      <div className="flex justify-between items-start md:items-center flex-col md:flex-row gap-6 w-full relative z-10">
                        <div className="flex-grow space-y-2">
                          <div className="flex items-center gap-4 flex-wrap">
                            ...
                            <Badge
                              variant="outline"
                              className="bg-white/80 dark:bg-teal-900/20 text-[#25C2A0] dark:text-teal-400 border-[#25C2A0]/30 font-bold px-3 py-1 rounded-full text-[10px] tracking-wider uppercase backdrop-blur-sm"
                            >
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <div className="space-y-2">
                          <div className="flex items-center gap-2.5">
                            ...
                            <span className="text-xs font-black text-[#266d61] dark:text-teal-500 uppercase tracking-widest">
                              Items List
                            </span>
                          </div>
                          ...
                          <div className="grid grid-cols-1 gap-3">
                            {deal.products?.length > 0 ? (
                              deal.products.map((prod, i) => (
                                <div
                                  key={i}
                                  className="flex items-center justify-between p-3 bg-white/60 dark:bg-slate-900/40 border border-[#25C2A0]/10 dark:border-slate-800/60 rounded-xl hover:bg-white transition-all"
                                >
                                  <span className="text-sm font-bold text-teal-900 dark:text-slate-200">
                                    {prod}
                                  </span>
                        ...
                        <div className="space-y-2 md:border-l border-[#25C2A0]/10 dark:border-slate-800 md:pl-4">
                          <div className="flex items-center gap-2.5">
                            ...
                            <span className="text-xs font-black text-[#266d61] dark:text-emerald-500 uppercase tracking-widest">
                              Est. Value
                            </span>
                          </div>
                        ...
                        <div className="space-y-2 lg:border-l border-[#25C2A0]/10 dark:border-slate-800 lg:pl-4">
                          <div className="flex items-center gap-2.5">
                            ...
                            <span className="text-xs font-black text-[#266d61] dark:text-blue-500 uppercase tracking-widest">
                              Timeline
                            </span>
                          </div>
                          <div className="space-y-2.5">
                            <div className="flex items-center justify-between p-2.5 bg-white/60 dark:bg-slate-950/40 rounded-xl border border-[#25C2A0]/10 group-hover:border-[#25C2A0]/30 transition-colors">
                              <div className="flex flex-col">
                                ...
                                <span className="font-bold text-xs text-teal-900 dark:text-slate-300">
                              ...
                              <div className="w-7 h-7 rounded-full border border-[#25C2A0]/30 flex items-center justify-center bg-white dark:bg-slate-900">
                                <span className="text-[10px] font-black text-[#25C2A0]">
                                  1st
                                </span>
                              </div>
                            </div>
